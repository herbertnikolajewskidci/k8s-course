...
| **Q8** | NetworkPolicy Ingress Isolation | `cka8448` | 7 | 2.5 | ⚠️ PARTIAL | – | Erlaubter Client erreicht Backend; Isolation gegen externe Zone fehlt |
...
| **Q13** | RBAC Triad (SA, Role, RoleBinding) | `cka3200` | 6 | **6** | ✅ PASS | – | SA `deploy-bot`, Role & RoleBinding vollständig mit exakten Rechten |
